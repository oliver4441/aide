      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-on-surface-variant">
              <li><a href="#" className="hover:text-on-surface transition-colors">Help Center</a></li>
              <li><a href="#" className="hover:text-on-surface transition-colors">API Docs</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-on-surface-variant">
              ...
              <li><a href="#" className="hover:text-on-surface transition-colors">Privacy</a></li>
              <li><a href="#" className="hover:text-on-surface transition-colors">Terms</a></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-outline-variant pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-on-surface-variant">&copy; 2026 Aide. All rights reserved.</p>
          <p className="text-[10px] text-on-surface-variant uppercase tracking-widest">Built by Omix Systems</p>
        </div>
      </div>
    </footer>
  );
